<?php
/**
 * TopTea POS - Main Layout View
 * Engineer: TopTea Engineering Team
 * Date: 2026-01-03
 * Architecture: Aligned with KDS standard structure
 *
 * This view is loaded by public/pos/index.php after authentication.
 * Authentication and session management are handled by AuthGuard and config.php.
 *
 * Variables available from public/pos/index.php:
 * - $csrf_token: CSRF token for JavaScript
 * - $cache_version: Asset cache busting version
 * - $_SESSION: Session data (user_id, display_name, store_name, user_role, etc.)
 */
?>
<!doctype html>
<html lang="zh-CN">
<head>
  ...
  <link href="<?php echo POS_BASE_URL; ?>assets/pos.css?v=<?php echo $cache_version; ?>" rel="stylesheet">
</head>
...
<script type="module" src="<?php echo POS_BASE_URL; ?>assets/js/main.js?v=<?php echo $cache_version; ?>"></script>
