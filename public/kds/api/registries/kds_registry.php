...
// [ARCHITECTURE UPDATE 2026-01-03] Load KDS helper files with new paths
// These files provide: json_ok, json_error, utc_now, get_product, KdsSopParser, etc.
require_once __DIR__ . '/../../../src/kds/Helpers/JsonHelper.php';
require_once __DIR__ . '/../../../src/kds/Helpers/DateTimeHelper.php';
require_once __DIR__ . '/../../../src/kds/Helpers/KdsRepository.php';
